    ...
    public void setDefaultIndicatorShape(Shape shape){
        if(mUserSetSelectedIndicatorResId == 0){
            if(shape == Shape.Oval){
                ...
                mSelectedGradientDrawable.setCornerRadius(mUnSelectedGradientDrawable.getMinimumHeight() / 2);
            }
        }
        if(mUserSetUnSelectedIndicatorResId == 0){
            if(shape == Shape.Oval){
                ...
                mUnSelectedGradientDrawable.setCornerRadius(mUnSelectedGradientDrawable.getMinimumHeight() / 2);
            }
        }
        resetDrawable();
    }
