...
public class SliderLayout extends RelativeLayout{
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int indicatorShape = attributes.getInt(R.styleable.SliderLayout_indicator_shape, 0);

        shape = PagerIndicator.Shape.values()[indicatorShape];
    ...
    public void setPresentIndcatorShape(PagerIndicator.Shape shape) {
        mIndicator.setDefaultIndicatorShape(shape);
        if (shape.ordinal() == 1) {
            mIndicator.setDefaultIndicatorSize(16, 2, PagerIndicator.Unit.DP);
        }
    }
